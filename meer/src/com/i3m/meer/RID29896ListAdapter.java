...
import com.i3m.meer.model.Radlex_rid10357_radlex_rid29896_Children;
import com.i3m.meer.model.Radlex_rid10357_radlex_rid29896_Group;
...
public class RID29896ListAdapter extends BaseExpandableListAdapter {
	...
	private ArrayList<Radlex_rid10357_radlex_rid29896_Group> groups;
	...
	public RID29896ListAdapter (Context context, ArrayList<Radlex_rid10357_radlex_rid29896_Group> children){
	...
	public Object getChild(int groupPosition, int childPosition) {
		ArrayList<Radlex_rid10357_radlex_rid29896_Children> children = groups.get(groupPosition).get_children();
		return children.get(childPosition);
	}

	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		View v = convertView;
		final Radlex_rid10357_radlex_rid29896_Children child = (Radlex_rid10357_radlex_rid29896_Children) getChild(groupPosition, childPosition);
	...
	public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		View v = convertView;
		final Radlex_rid10357_radlex_rid29896_Group group = (Radlex_rid10357_radlex_rid29896_Group) getGroup(groupPosition);
